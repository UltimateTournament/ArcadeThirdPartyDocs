...
For leaderboard games, integration can be summarized to the following:
...
4. The game server must be able to adjust constant time to pause when waiting for new inputs, and simluate as fast a possible (`0` constant time) when inputs are provided.
